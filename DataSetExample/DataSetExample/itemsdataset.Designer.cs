...
namespace DataSetExample {
    ...
    public partial class itemsdataset : global::System.Data.DataSet {
        ...
        public partial class itemsDataTable : global::System.Data.TypedTableBase<itemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public itemsRow AdditemsRow(int itemid, string itemname, double price, int quantity) {
...
namespace DataSetExample.itemsdatasetTableAdapters {
    ...
    public partial class itemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[items] WHERE (([itemid] = @Original_itemid) AND ((@IsNull_itemname = 1 AND [itemname] IS NULL) OR ([itemname] = @Original_itemname)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[items] ([itemid], [itemname], [price], [quantity]) VALUES (@it" +
                "emid, @itemname, @price, @quantity);\r\nSELECT itemid, itemname, price, quantity F" +
                "ROM items WHERE (itemid = @itemid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[items] SET [itemid] = @itemid, [itemname] = @itemname, [price] = @price, [quantity] = @quantity WHERE (([itemid] = @Original_itemid) AND ((@IsNull_itemname = 1 AND [itemname] IS NULL) OR ([itemname] = @Original_itemname)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)));
SELECT itemid, itemname, price, quantity FROM items WHERE (itemid = @itemid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataSetExample.Properties.Settings.Default.DatabaseSQLDemoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT itemid, itemname, price, quantity FROM dbo.items";
        ...
        public virtual int Delete(int Original_itemid, string Original_itemname, global::System.Nullable<double> Original_price, global::System.Nullable<int> Original_quantity) {
        ...
        public virtual int Insert(int itemid, string itemname, global::System.Nullable<double> price, global::System.Nullable<int> quantity) {
        ...
        public virtual int Update(int itemid, string itemname, global::System.Nullable<double> price, global::System.Nullable<int> quantity, int Original_itemid, string Original_itemname, global::System.Nullable<double> Original_price, global::System.Nullable<int> Original_quantity) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string itemname, global::System.Nullable<double> price, global::System.Nullable<int> quantity, int Original_itemid, string Original_itemname, global::System.Nullable<double> Original_price, global::System.Nullable<int> Original_quantity) {
            return this.Update(Original_itemid, itemname, price, quantity, Original_itemid, Original_itemname, Original_price, Original_quantity);
        }
    }
